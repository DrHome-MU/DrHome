namespace Dr_Home.DTOs.SchedulesDTOs
{
    public class ScheduleRequestValidator:AbstractValidator<ScheduleRequest>
    {
        ...
        private bool ValidateDuration(int AppointmentDurationInMiniutes)
        {
            return (AppointmentDurationInMiniutes >= 5);
        }

        private bool ValidateTimes(ScheduleRequest request)
        {
